...
function theme_boost_crtv_ind_get_main_scss_content($theme) {
    ...
    if ($filename == 'default.scss') {
        ...
        $scss .= file_get_contents($CFG->dirroot . '/theme/boost_crtv_ind/scss/preset/UnitecTePukengaDark.scss');
    } else if ($filename == 'UnitecTePukengaLight.scss') {
        $scss .= file_get_contents($CFG->dirroot . '/theme/boost_crtv_ind/scss/preset/UnitecTePukengaLight.scss');
