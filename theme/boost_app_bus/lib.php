 ...
 * @return string
 */
function theme_boost_app_bus_get_extra_scss($theme) {
    $content = '';
 ...
 * @return string
 */
function theme_boost_app_bus_get_main_scss_content($theme) {
    global $CFG;
 ...
 */
function theme_boost_app_bus_get_precompiled_css() {
    global $CFG;
    return file_get_contents($CFG->dirroot . '/theme/boost_app_bus/style/moodle.css');
}
 ...
 * @return array
 */
function theme_boost_app_bus_get_pre_scss($theme) {
    global $CFG;
